/**
 * Icones das plataformas oficiais — reutilizados na landing,
 * tabelas, modais de cadastro etc. Todos usam currentColor.
 */
...
/**
 * PlatformBadgeList — lista compacta de icones (usada em tabelas, cards).
 * platforms = ['instagram', 'tiktok', ...]
 */
export function PlatformBadgeList({ platforms, size = 16, className = '' }) {
  return (
