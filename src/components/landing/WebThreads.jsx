/*
 * WebThreads — componente de fundo animado do React Bits (reactbits.dev),
 * variante JS + CSS, adicionado em 03/09/2026 via registry oficial.
 *
 * Código de terceiro, mantido o mais próximo possível do original para que a
 * atualização do upstream continue sendo uma substituição de arquivo. Não
 * editar aqui: ajustes de comportamento do produto ficam em
 * `FundoDeThreads.jsx`, que envolve este componente.
 *
 * Renderiza com WebGL 2.0 através de `ogl`.
 */
